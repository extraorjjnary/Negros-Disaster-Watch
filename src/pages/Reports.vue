...
// Store chart instances so we can destroy on unmount (prevents canvas reuse error)
let charts = [];
...
// CRITICAL: destroy charts on unmount to prevent canvas reuse errors on re-navigation
onUnmounted(() => {
  ...
  <div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
      <div class="dash-card">
        ...
        <p class="text-[11px] text-muted mt-1">Total Alerts Issued (2024)</p>
        <p class="text-[10.5px] text-danger mt-1">↑ 12% vs 2023</p>
      </div>
      <div class="dash-card">
        <p class="font-mono-custom text-2xl font-medium text-warning">23</p>
        <p class="text-[11px] text-muted mt-1">Flood Events (2024)</p>
        <p class="text-[10.5px] text-danger mt-1">↑ 4 vs 2023</p>
      </div>
      <div class="dash-card col-span-2 sm:col-span-1">
        ...
        <p class="text-[10.5px] text-safe mt-1">↓ 0.2% vs 2023</p>
      </div>
    </div>
      ...
      <div class="dash-card">
        <div class="flex items-center justify-between mb-3">
          <h2 class="font-cond font-bold text-[15px] text-ink">
            Monthly Rainfall (mm) — 2024
          </h2>
          <button class="btn btn-ghost btn-sm">⬇ Export</button>
        </div>
        <div class="relative h-52"><canvas ref="rainfallEl" /></div>
      </div>
      <div class="dash-card">
        <div class="flex items-center justify-between mb-3">
          <h2 class="font-cond font-bold text-[15px] text-ink">
            Flood Risk Level — 2024
          </h2>
          <button class="btn btn-ghost btn-sm">⬇ Export</button>
        </div>
        <div class="relative h-52"><canvas ref="floodEl" /></div>
      </div>
    </div>
    <div class="dash-card">
      <div class="flex items-center justify-between mb-3">
      ...
      <div class="relative h-44"><canvas ref="seismicEl" /></div>
    </div>
  </div>
</template>
