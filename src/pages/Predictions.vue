...
<template>
  ...
  <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
    ...
    <div class="dash-card text-center">
      ...
      <p class="text-[11px] text-muted mt-1">High-Risk Predictions Active</p>
    </div>
    <div class="dash-card text-center">
    ...
    <div class="dash-card text-center">
      ...
      <p class="text-[11px] text-muted mt-1">Max Forecast Horizon</p>
    </div>
  </div>
  ...
  <Transition name="fade">
    ...
    >
      <div
        class="bg-panel border border-border-light rounded-xl p-6 w-full max-w-md shadow-2xl"
      >
        ...
        <p class="text-[13px] text-muted mb-5 leading-relaxed">
          This simulates sending an emergency alert to all registered PDRRMO
          personnel and LGU contacts.
          <strong class="text-ink"
            >No actual notifications will be sent in demo mode.</strong
          >
        </p>
        ...
        >
          ...
          <p class="text-muted leading-relaxed">
            Alert type: <strong class="text-ink">{{ simType }}</strong
            ><br />
            Affected area: <strong class="text-ink">{{ simArea }}</strong
            ><br />
            Channels: SMS · Mobile App · Web · Radio<br />
            Simulated recipients: <strong class="text-ink">48,220</strong><br />
            Delivery simulation: 2.4 seconds<br />
            <em class="text-faint">No real notifications sent — demo mode.</em>
          </p>
